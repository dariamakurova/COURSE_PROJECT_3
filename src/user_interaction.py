...
def get_user_choice(database_name, params):
...
def user_interaction():
    ...
    print("Сейчас я сформирую базу данных с информацией о 10 топовых работодателях и их открытых вакансиях.\n"
